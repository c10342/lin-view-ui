...
function createInstance(options) {
  return new Promise((resolve, reject) => {
    new LinMessageBox({ ...options, resolve, reject });
  });
}

createInstance.alert = function(options) {
  return new Promise((resolve, reject) => {
    const common = {
      closeOnClickModal: false,
      closeOnPressEscape: false,
    };
    new LinMessageBox({ ...options, ...common, resolve, reject });
  });
};

createInstance.confirm = function(options) {
  return new Promise((resolve, reject) => {
    const common = {
...
createInstance.prompt = function(options) {
  return new Promise((resolve, reject) => {
    const common = {
      showInput: true,
      showCancelButton:true
