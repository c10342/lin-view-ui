        ...
        return (
            ...
            >
                <div
                    ...
                    {
                        isScroll ? (<span class='lin-tab-group-icon lin-icon-left' onClick={onPrevClick}></span>) : null
                    }
                    {
                        isScroll ? (<span class='lin-tab-group-icon lin-icon-right' onClick={onNextClick}></span>) : null
                    }
            ...
            this.$nextTick(() => {
                if (this.currentValue !== -1) {
                    ...
                    if (dom) {
                        ...
                        const tabheaderWrapperX = tabheaderWrapper.getBoundingClientRect().x;
