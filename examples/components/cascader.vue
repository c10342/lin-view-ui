<template>
  <div>
    ...
    <div>
      <lin-cascader :options="[]"> </lin-cascader>
    </div>
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    this.value.push(options[0]);
    this.value.push(options[0].children[0]);
    this.value.push(options[0].children[0].children[0]);
  },
  methods: {
    showFormat(data) {
      // console.log(data);
